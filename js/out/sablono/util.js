...
sablono.util.ToString = (function (){var obj12566 = {};return obj12566;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__5041__auto__ = x;if(and__5041__auto__)
...
{var x__5680__auto__ = (((x == null))?null:x);return (function (){var or__5053__auto__ = (sablono.util.to_str[goog.typeOf(x__5680__auto__)]);if(or__5053__auto__)
{return or__5053__auto__;
} else
{var or__5053__auto____$1 = (sablono.util.to_str["_"]);if(or__5053__auto____$1)
...
sablono.util.ToURI = (function (){var obj12568 = {};return obj12568;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__5041__auto__ = x;if(and__5041__auto__)
...
{var x__5680__auto__ = (((x == null))?null:x);return (function (){var or__5053__auto__ = (sablono.util.to_uri[goog.typeOf(x__5680__auto__)]);if(or__5053__auto__)
{return or__5053__auto__;
} else
{var or__5053__auto____$1 = (sablono.util.to_uri["_"]);if(or__5053__auto____$1)
{return or__5053__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__12569){
var xs = cljs.core.seq(arglist__12569);
...
{var ks = cljs.core.keys.call(null,m);var kmap = cljs.core.zipmap.call(null,ks,cljs.core.map.call(null,sablono.util.camel_case,ks));var G__12573 = clojure.set.rename_keys.call(null,m,kmap);var G__12573__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__12573,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__12573);return G__12573__$1;
} else
{return m;
}
});
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__12574_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__12574_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__12574_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__12574_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__12575){
var maps = cljs.core.seq(arglist__12575);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__12579 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));var tag_name = cljs.core.nth.call(null,vec__12579,(0),null);var names = cljs.core.nth.call(null,vec__12579,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__12579,tag_name,names){
return (function (p1__12576_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__12576_SHARP_));
});})(matches,vec__12579,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__12579,tag_name,names){
return (function (p1__12577_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__12577_SHARP_));
});})(matches,vec__12579,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__12580){var vec__12583 = p__12580;var tag = cljs.core.nth.call(null,vec__12583,(0),null);var content = cljs.core.nthnext.call(null,vec__12583,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__12584 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__12584,(0),null);var id = cljs.core.nth.call(null,vec__12584,(1),null);var class$ = cljs.core.nth.call(null,vec__12584,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__5053__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__5053__auto__))
{return or__5053__auto__;
} else
