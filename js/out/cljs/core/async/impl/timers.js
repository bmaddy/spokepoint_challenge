...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__5620__auto__,writer__5621__auto__,opt__5622__auto__){return cljs.core._write.call(null,writer__5621__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_16446 = (0);while(true){
if((i_16446 < arr.length))
{(arr[i_16446] = null);
{
var G__16447 = (i_16446 + (1));
i_16446 = G__16447;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__5620__auto__,writer__5621__auto__,opt__5622__auto__){return cljs.core._write.call(null,writer__5621__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_16453 = (self__.level + (1));while(true){
if((i_16453 <= (new_level + (1))))
{(update[i_16453] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16455 = (0);while(true){
if((i_16455 <= self__.level))
{var links_16456 = (update[i_16455]).forward;if(((links_16456[i_16455]) === x__$1))
{(links_16456[i_16455] = (x__$1.forward[i_16455]));
{
var G__16457 = (i_16455 + (1));
i_16455 = G__16457;
continue;
}
} else
{{
var G__16458 = (i_16455 + (1));
i_16455 = G__16458;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__5053__auto__ = (cljs.core.truth_((function (){var and__5041__auto__ = me;if(cljs.core.truth_(and__5041__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__5041__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__5053__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__5053__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__5053__auto__,timeout__$1,me))
,msecs);
