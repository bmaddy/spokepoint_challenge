...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16539 = (0);while(true){
var m_16540 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16540 == null))
{} else
{m_16540.call(null);
if((count_16539 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16541 = (count_16539 + (1));
count_16539 = G__16541;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__5041__auto__)
