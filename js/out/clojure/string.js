...
{{
var G__16804 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16804;
continue;
}
} else
...
{var pred__16808 = cljs.core._EQ_;var expr__16809 = limit;if(cljs.core.truth_(pred__16808.call(null,(1),expr__16809)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16808.call(null,(2),expr__16809)))
...
var G__16811 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16812 = (limit__$1 - (1));
var G__16813 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__16811;
limit__$1 = G__16812;
parts = G__16813;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___16815 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___16815))
{var replacement_16816 = temp__4124__auto___16815;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_16816)));
} else
{buffer.append(ch);
}
{
var G__16817 = (index + (1));
index = G__16817;
continue;
}
}
