...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj11645 = {};return obj11645;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5041__auto__ = this$;if(and__5041__auto__)
...
{var x__5680__auto__ = (((this$ == null))?null:this$);return (function (){var or__5053__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__5680__auto__)]);if(or__5053__auto__)
{return or__5053__auto__;
} else
{var or__5053__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5053__auto____$1)
...
return (function (p__11646){var vec__11647 = p__11646;var k = cljs.core.nth.call(null,vec__11647,(0),null);var v = cljs.core.nth.call(null,vec__11647,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__11648){var vec__11649 = p__11648;var k = cljs.core.nth.call(null,vec__11649,(0),null);var v = cljs.core.nth.call(null,vec__11649,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
